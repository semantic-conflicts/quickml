...
public class DownsamplingPredictiveModelBuilderTest {
  @Test public void simpleTest(){
    ...
    when(predictiveModelBuilder.buildPredictiveModel(Mockito.any(Iterable.class))).thenAnswer(new Answer<Classifier>(){
      @Override public Classifier answer(      final InvocationOnMock invocationOnMock) throws Throwable {
  ...
  @Test public void simpleBmiTest() throws IOException, ClassNotFoundException {
...
public static class SamePredictionPredictiveModel extends Classifier {
    public static long serialVersionUID=8241616760952568181L;
    public double prediction;
    public SamePredictionPredictiveModel(    double prediction){
      this.prediction=prediction;
    }
    @Override public void dump(    final Appendable appendable){
      throw new UnsupportedOperationException();
    }
    @Override public MapWithDefaultOfZero predict(    Map<String,Serializable> attributes){
    ...
    public SamePredictionPredictiveModel(){
    }
  }
  public DownsamplingPredictiveModelBuilderTest(){
  }
}
