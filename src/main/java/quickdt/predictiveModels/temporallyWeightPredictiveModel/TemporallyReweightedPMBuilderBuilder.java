...
public class TemporallyReweightedPMBuilderBuilder implements PredictiveModelBuilderBuilder<TemporallyReweightedPM,TemporallyReweightedPMBuilder> {
  public static String HALF_LIFE_OF_NEGATIVE="halfLifeOfNegative";
  public static String HALF_LIFE_OF_POSITIVE="halfLifeOfPositive";
  public PredictiveModelBuilderBuilder<?,?> wrappedBuilderBuilder;
  ...
  @Override public Map<String,FieldValueRecommender> createDefaultParametersToOptimize(){
  ...
  @Override public TemporallyReweightedPMBuilder buildBuilder(  final Map<String,Object> predictiveModelConfig){
  ...
  public TemporallyReweightedPMBuilderBuilder(){
  }
}
